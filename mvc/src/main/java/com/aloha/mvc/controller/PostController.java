 ...
 * 
 * [GET]        - / posts/create        : 등록화면
 * [POST]       - / posts/create        : 등록처리 (FORM)
 * [POST]       - / posts               : 등록처리 (JSON)
 * 
 * [GET]        - / posts/update        : 수정화면
 * [POST]       - / posts/update        : 수정처리 (FORM)
 * [PUT]        - / posts               : 수정처리  (JSON)
 * 
 * [POST]     - / posts/delete        : 삭제처리 (FORM)
 * [DELETE]     - / posts/delete        : 삭제처리 (JSON)
 *
 */
